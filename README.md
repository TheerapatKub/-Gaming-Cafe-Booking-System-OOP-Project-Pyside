...
- ⚡ **เลือกประเภทเครื่อง**: Standard (40฿/ชม.) | Premium (80฿/ชม.) | VR / Private Room (250฿/ชม.)
- 👑 **ระบบสมาชิก**: ทั่วไป / VIP (ส่วนลดต่างกัน)
...
| **5️⃣ เลือกประเภทสมาชิก** | **สมาชิกทั่วไป** หรือ **VIP** (ส่วนลด 15%) |
| **6️⃣ กรอกข้อมูล** | กรอกชื่อ-นามสกุล และเบอร์โทรศัพท์ |
| **7️⃣ เลือกชำระเงิน** | เลือก **สแกนจ่าย** หรือ **จ่ายที่ร้าน** |
| **8️⃣ ยืนยัน** | กดปุ่ม "ดำเนินการชำระเงิน" เพื่อยืนยันการจอง |
...
> 💡 ราคาจะคำนวณและแสดงทางขวามือแบบ real-time เมื่อเลือกโซน เครื่อง และประเภทสมาชิก (VIP ได้ส่วนลด 15%)

---

## 🎨 Media / ไอคอน

วางไฟล์รูปใน `assets/icons/` ดังนี้:

| ไฟล์ | รายละเอียด |
|------|-------------|
| `standard.png` | 🖥️ เครื่องมาตรฐาน |
| `premium.png` | 🖥️ เครื่องพรีเมียม |
| `vr.png` | 🖥️Private Room |

> 📌 แหล่งดาวน์โหลดฟรี: [Flaticon](https://www.flaticon.com) · [Icons8](https://icons8.com) · [Heroicons](https://heroicons.com)  
> *หากไม่มีไฟล์ โปรแกรมจะใช้ emoji แทนอัตโนมัติ* 🎯
